...
| 005 | condition-checklist-redesign | How should the grouped multi-select condition checklist look/behave — does it need to move off a leading-checkbox pattern to a native iOS trailing-checkmark list? | ★ B: Native iOS List (trailing checkmark, "None" as a row) | checklist, forms, accessibility, onboarding, phase-1, screening |
