...
- [x] 04.2-03-PLAN.md — ChildEntryRecord + per-entry child CRUD on HealthDataStore
...
- [x] 04.1-07-PLAN.md — Privacy Zones + the on-device capture→zone-check→geocode→discard sequence
  (GROUPEVENTS-03)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 04.1-08-PLAN.md — Small, closed, invite-only groups + membership-scoping predicate, server-side
  (GROUPEVENTS-01, HOUSEHOLD-02)

- [x] 04.1-09-PLAN.md — Friend-circle client surface: friends list, incoming requests, Add Friend
...
- [x] 04.1-11-PLAN.md — Group client surface: create group, invite, view membership, remove member
  (GROUPEVENTS-01, HOUSEHOLD-02)

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 04.1-12-PLAN.md — Group-only feed, fixed cheer mechanic, export-consent gate, server-side
  (GROUPEVENTS-04, GROUPEVENTS-05)

- [x] 04.1-13-PLAN.md — Goal-Event client surfaces (create/RSVP, separate from the completion feed)
  (GROUPEVENTS-02, GROUPEVENTS-05)

**Wave 8** *(blocked on Wave 7 completion)*

- [x] 04.1-14-PLAN.md — Completion-logging screen: binary done + optional own-time/photo/location
  opt-ins (GROUPEVENTS-02, GROUPEVENTS-03)

**Wave 9** *(blocked on Wave 8 completion)*

- [x] 04.1-15-PLAN.md — Group feed client surface: completion cards, every non-comparative rule
  enforced visually (GROUPEVENTS-04, GROUPEVENTS-02)

**Wave 10** *(blocked on Wave 9 completion)*

- [x] 04.1-16-PLAN.md — Digital finisher certificate: auto-generated, server-stripped-photo-only,
