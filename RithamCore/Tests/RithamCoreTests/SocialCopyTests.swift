...
struct SocialCopyTests {
    ...
    private static let shippedStrings: [(name: String, value: String)] = [
        ...
        ("Completion.logCTA", SocialCopy.Completion.logCTA),
        ("Completion.addTimeCTA", SocialCopy.Completion.addTimeCTA),
        ("Completion.skipCTA", SocialCopy.Completion.skipCTA),
        ("Completion.neverMindCTA", SocialCopy.Completion.neverMindCTA),
        ("Completion.saveTimeCTA", SocialCopy.Completion.saveTimeCTA),
        ("Completion.durationFieldLabel", SocialCopy.Completion.durationFieldLabel),
        ("Completion.photoPrompt", SocialCopy.Completion.photoPrompt),
        ("Completion.photoOnOption", SocialCopy.Completion.photoOnOption),
        ("Completion.photoOffOption", SocialCopy.Completion.photoOffOption),
        ("Completion.choosePhotoCTA", SocialCopy.Completion.choosePhotoCTA),
        ("Completion.photoAttachedConfirmation", SocialCopy.Completion.photoAttachedConfirmation),
        ("Completion.photoUploadFailed", SocialCopy.Completion.photoUploadFailed),
        ("Completion.locationPrompt", SocialCopy.Completion.locationPrompt),
        ("Completion.locationOnOption", SocialCopy.Completion.locationOnOption),
        ("Completion.locationOffOption", SocialCopy.Completion.locationOffOption),
        ("Completion.noteFieldLabel", SocialCopy.Completion.noteFieldLabel),
        ("Completion.privateSectionHeading", SocialCopy.Completion.privateSectionHeading),
        ("Completion.privateDistanceFieldLabel", SocialCopy.Completion.privateDistanceFieldLabel),
        ("Completion.privateDurationFieldLabel", SocialCopy.Completion.privateDurationFieldLabel),
        ("Completion.logFailed", SocialCopy.Completion.logFailed),
        ("Completion.retryCTA", SocialCopy.Completion.retryCTA),
