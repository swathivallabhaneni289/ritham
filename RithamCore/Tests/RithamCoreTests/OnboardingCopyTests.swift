...
struct OnboardingCopyTests {
    ...
    private static let allConstants: [String] = [
        ...
        OnboardingCopy.Diet.allergensHeadline,
        OnboardingCopy.Diet.allergensHelper,
        OnboardingCopy.Diet.allergenOptionMilk,
        OnboardingCopy.Diet.allergenOptionEggs,
        OnboardingCopy.Diet.allergenOptionFish,
        OnboardingCopy.Diet.allergenOptionShellfish,
        OnboardingCopy.Diet.allergenOptionTreeNuts,
        OnboardingCopy.Diet.allergenOptionPeanuts,
        OnboardingCopy.Diet.allergenOptionWheat,
        OnboardingCopy.Diet.allergenOptionSoy,
        OnboardingCopy.Diet.allergenOptionSesame,
        OnboardingCopy.Diet.allergenOptionOther,
